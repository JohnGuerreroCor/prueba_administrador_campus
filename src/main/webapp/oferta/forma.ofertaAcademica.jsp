	...
	<div class="md-dialog-content" data-slayer-responsivo>
		<div layout="row" flex="100" layout-xs="column">
			...
			<div layout="column" flex>
				...
				{{programa.uaa.nombre}} </md-option> </md-select>
		...
		<div layout="row" flex="100" layout-xs="column">
			<div layout="column" flex>
				<md-input-container class="md-block md-input-has-placeholder"
					flex-gt-sm="50"> <label>Fecha Inicio de Inscripción</label>
					<input type="datetime" datetime-picker date-format="yyyy-MM-dd HH:mm:ss" close-on-select="true"
					placeholder="YYYY-MM-DD HH:MM:SS" min-date="minDate"
					ng-model="ofertaAcademica.inscripcionFechaInicio" class=" md-input"
					name="inscripcionFechaInicio" required="required" ng-pattern="/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$/">
					<div data-ng-messages="frmOfertaAcademica.inscripcionFechaInicio.$error">
						<div data-ng-message="required">Campo requerido.</div>
						<div data-ng-message="min-date">Fecha no valida.</div>
						<div ng-message="pattern">YYYY-MM-DD HH:MM:SS Fecha invalida.</div>
					</div> 
				</md-input-container>
			</div>
			<div layout="column" flex>
				<md-input-container class="md-block md-input-has-placeholder"
					flex-gt-sm="50"> <label>Fecha Fin de Inscripción</label> 
					<input datetime-picker date-format="yyyy-MM-dd HH:mm:ss" close-on-select="true"
					...
					name="inscripcionFechaFin" required="required"
					ng-pattern="/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$/">
					<div data-ng-messages="frmOfertaAcademica.inscripcionFechaFin.$error">
						<div data-ng-message="required">Campo requerido.</div>
						<div data-ng-message="min-date">Fecha no valida.</div>
						<div ng-message="pattern">YYYY-MM-DD HH:MM:SS Fecha invalida.</div>
					</div>  
		...
		<div layout="row" flex="100" layout-xs="column">
			<div layout="column" flex>
				<md-input-container class="md-block md-input-has-placeholder"
					flex-gt-sm="50"> <label>Fecha Inicio del Curso</label> 
					<input datetime-picker date-format="yyyy-MM-dd HH:mm:ss" close-on-select="true"
					...
					ng-pattern="/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$/">
					<div data-ng-messages="frmOfertaAcademica.fechaInicio.$error">
						<div data-ng-message="required">Campo requerido.</div>
						<div data-ng-message="min-date">Fecha no valida.</div>
						<div ng-message="pattern">YYYY-MM-DD HH:MM:SS Fecha invalida.</div>
					</div>  
			...
			<div layout="column" flex>
				<md-input-container class="md-block md-input-has-placeholder"
					flex-gt-sm="50"> <label>Fecha Fin del Curso</label>
					<input datetime-picker date-format="yyyy-MM-dd HH:mm:ss" close-on-select="true"
					placeholder="YYYY-MM-DD HH:MM:SS"
					min-date="ofertaAcademica.fechaInicio" class=" md-input"
					data-ng-model="ofertaAcademica.fechaFin" name="fechaFin"required="required"
					ng-pattern="/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2}$/">
					<div data-ng-messages="frmOfertaAcademica.fechaFin.$error">
						<div data-ng-message="required">Campo requerido.</div>
						<div data-ng-message="min-date">Fecha no valida.</div>
						<div ng-message="pattern">YYYY-MM-DD HH:MM:SS Fecha invalida.</div>
					</div> 
		...
		<div layout="row" flex="100" layout-xs="column">
			...
			<div layout="column" flex>
				<md-input-container class="md-block"> <label>Calendario</label>
				<md-select data-ng-model="ofertaAcademica.calendario.codigo"
					id="codigocalendario" name="codigocalendario"required=""> <md-option
					data-ng-repeat="calendarios in JSONCalendarios" value="{{calendarios.codigo}}">
				{{calendarios.nombre}} </md-option> </md-select>
				<div data-ng-messages="frmOfertaAcademica.codigoCalendario.$error">
					<div data-ng-message="required">Campo requerido.</div>
				</div>
				</md-input-container>
			</div>
